...
class ModelFreeCollisionDetector_Simple():
    ...
    def detect(self, scene_points ,grasp_group, approach_dist=0.03, collision_thresh=0.05, return_empty_grasp=False, empty_thresh=0.01, return_ious=False):
        ...
        targets = scene_points[np.newaxis,:,:] - T[:,np.newaxis,:]
